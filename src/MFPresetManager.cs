...
namespace MovementFunk
{
  internal class MFPresetManager
  {
    ...
    public static void LaunchPreset()
    {
      ...
      bool movementDirExisted = true;
      bool speedometerDirExisted = true;
      ...
      if(!movementDirExisted){
        NoMovementPreset();
      }
      if(!speedometerDirExisted){
        NoSpeedometerPreset();
      }
